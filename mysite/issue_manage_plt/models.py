...
class Project(models.Model):
    ...
    # 8. 实际结果
    actual = models.TextField(default=" ", verbose_name="实际结果")

    # 9. 复现概率
    repro = models.TextField(default=" ", verbose_name="复现概率")

    # 10. 配置信息
    config = models.TextField(default="", verbose_name="配置信息")

    # 11. 蓝牙地址
    bt_address = models.TextField(default=" ", verbose_name="蓝牙地址")
    ...
    timestamp = models.TextField(default=" ", verbose_name="时间戳")
